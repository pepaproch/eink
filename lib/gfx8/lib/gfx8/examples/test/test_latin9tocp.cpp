...
Program: test_latin9tocp_clock

Purpose: Test latin9tocp() function
...
void setup() {  
  ...
  // test all characters in GFX Latin 9
  ...
  // These were included above
  ts = "€ŠšŽžŒœŸ";
  dumpString(ts, "Latin 9 characters not in Latin 1");
  
  // Result will depend on value of INVALIDATE_OVERWRITTEN_LATIN_1_CHARS 
  // in ../lib/gfxlatin9/gfxlatin9.cpp
  ts = "¤¦¨´¸¼½¾";
  dumpString(ts, "Latin 1 characters not in Latin 9"); 

  ts = "Ă"; // U+0102 LATIN CAPITAL LETTER A WITH BREVE
  dumpString(ts, "Non latin9 char U+0102 LATIN CAPITAL LETTER A WITH BREVE");
  ...
  /* errors covered in ../lib/decodeutf8/examples/decodeerrors.cpp */
 }
