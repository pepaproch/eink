...
Program: 4-check_gfx8

Purpose: Digital clock using gf8x GFXFont defined with fontconvert8x
...
#define AM_STR ">=<"      // clock.h " am" encoding
#define PM_STR ">;<"      // clock.h " pm" encoding
